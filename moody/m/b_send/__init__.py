        ...
        try:
            ...
            if 'data' in _t:
                ...
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -add_signer")
    ...
    def block_send(self, token_addr: str, addresses: List[str], amounts: List[int], gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> bool:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -bulk_send_token")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
    ...
    def block_send(self, addresses: List[str], amounts: List[int], gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> bool:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -bulk_send_trx")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
    ...
    def block_send(self, gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> bool:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -deposit")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
    ...
    def block_send(self, gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> None:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -renounce_signer")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
    ...
    def block_send(self, eth_send_fee: int, gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> bool:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -set_eth_fee")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
    ...
    def block_send(self, token_send_fee: int, gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> bool:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -set_token_fee")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
    ...
    def block_send(self, addr: str, amount: int, gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> bool:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -withdraw_ether")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
    ...
    def block_send(self, token_addr: str, to: str, amount: int, gas: int, price: int, val: int = 0, debug: bool = False, receiptListen: bool = False) -> bool:
        ...
        try:
            ...
            if 'data' in _t:
                ...
                tx_receipt = None
                if receiptListen is True:
                    print("======== awaiting Confirmation 🚸️ -withdraw_token")
                    tx_receipt = self._web3_eth.waitForTransactionReceipt(txHash)
                    if debug:
                        print("======== TX Result ✅")
                        print(tx_receipt)
...
class BSend(ContractBase):
    ...
    def __init__(
        ...
        self.SIGNATURES = SignatureGenerator(BSend.abi())
        ...
        self._fn_renounce_signer = RenounceSignerMethod(core_lib, contract_address, functions.renounceSigner)
